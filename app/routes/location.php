...
Route::get('edit-my-location/{location_id}', 'LocationManagementController@editLocation');
Route::post('edit-location', 'LocationManagementController@editLocationSave');
